          ...
          <div class="col-lg-8" id="signUpSt">
			<form action="signUp" method="post" enctype="multipart/form-data" id="signUpForm">
              ...
              <div class="row" >
                ...
                <div class="form-group mt-3">
                  <input type="text" name="phone" class="form-control" id="inputPhone" oninput="autoHyphen(this)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="13" placeholder="전화번호 입력">
