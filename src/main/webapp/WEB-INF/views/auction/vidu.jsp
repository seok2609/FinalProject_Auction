...
<script type="application/octet-stream" src="/static/openvidu-custom-ui/src/app/app.component.ts"></script>
<script type="application/octet-stream" src="/static/openvidu-custom-ui/src/app/app.module.ts"></script>
